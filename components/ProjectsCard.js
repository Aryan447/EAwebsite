      ...
      <div className="grid xl:-mb-16">
        <a href={props.link} target="_blank" rel="noopener noreferrer">
          <div className="flex justify-center items-start h-1/4">
            <Image src={props.image} className="rounded-3xl cover mt-10 h-56 w-80 mr-1.5 xl:mt-6 xl:mb-20" />
          </div>
        </a>
        <div className="text-left xl:ml-28">
          <div className="flex justify-center items-start h-1/4">
            <h1 className="font-inter xl:-mt-72 xl:ml-96 font-bold">{props.title}</h1>
          </div>
        </div>
        <div className="xl:ml-28 ml-2 mr-3">
          <div className="flex mt-2 items-start h-1/4">
